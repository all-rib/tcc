...
\author{Allan de Mello Ribeiro}  % Seu nome
\authorbib{Ribeiro, Allan} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Coloque o título aqui - O título deve ser claro e preciso variaveis.tex} % Título do trabalho
\titleen{Put your english title here variaveis.tex} % Título traduzido para inglês
\advisor{Nome Orientador completo e título variaveis.tex} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
% Se não houver corientador, comente a linha a baixo
\coadvisor{Nome Orientador completo e título variaveis.tex} % Nome do coorientador, caso exista. Caso não exista, comente a linha.
\depositshortdate{ANO variaveis.tex} % Ano em que depositou este documento
\approvaldate{01/janeiro/2021 variaveis.tex}
...
\evalboardmember{Nome completo e por extenso do Membro 1 variaveis.tex}{Título (especialização, mestrado, doutorado variaveis.tex}{Nome completo e por extenso da instituição a qual possui vínculo variaveis.tex}
\evalboardmember{Nome completo e por extenso do Membro 2 variaveis.tex}{Título (especialização, mestrado, doutorado variaveis.tex}{Nome completo e por extenso da instituição a qual possui vínculo variaveis.tex}
\evalboardmember{Nome completo e por extenso do Membro 3 variaveis.tex}{Título (especialização, mestrado, doutorado variaveis.tex}{Nome completo e por extenso da instituição a qual possui vínculo variaveis.tex}
\evalboardmember{Nome completo e por extenso do Membro 4 variaveis.tex}{Título (especialização, mestrado, doutorado variaveis.tex}{Nome completo e por extenso da instituição a qual possui vínculo variaveis.tex}
...
\PalavraChaveA{Palavra-chave 1 variaveis.tex}%% Palavra-chave A
\PalavraChaveB{Palavra-chave 2 variaveis.tex}%% Palavra-chave B
\PalavraChaveC{Palavra-chave 3 variaveis.tex}%% Palavra-chave C
\PalavraChaveD{Palavra-chave 4 variaveis.tex}%% Palavra-chave D
\PalavraChaveE{Palavra-chave 5 variaveis.tex}%% Palavra-chave E
...
\KeywordA{Keyword 1variaveis.tex}%% Keyword A
\KeywordB{Keyword 2 variaveis.tex}%% Keyword B
\KeywordC{Keyword 3 variaveis.tex}%% Keyword C
\KeywordD{Keyword 4 variaveis.tex}%% Keyword D
\KeywordE{Keyword 5 variaveis.tex}%% Keyword E
