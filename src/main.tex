...
% Comente para remover quaisquer um destes itens

\include{./capitulos/1-introducao}

\include{./capitulos/2-conceitos}

\include{./capitulos/3-trabalhos-relacionados}

\include{./capitulos/4-proposta}

\include{./capitulos/5-metodologia}

\include{./capitulos/6-experimentos-resultados}
