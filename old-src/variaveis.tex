...
\PalavraChaveA{Api\'ario}%% Palavra-chave A
\PalavraChaveB{Angustula}%% Palavra-chave B
...
\KeywordA{Apiary}%% Keyword A
\KeywordB{Angustula}%% Keyword B
\KeywordC{Sensoring}%% Keyword C
\KeywordD{Monitoring}%% Keyword D
