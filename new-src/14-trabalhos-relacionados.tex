...
\cite{Machado2024} faz uma pesquisa extensiva nos mesmos tópicos, provendo uma
...
Análise de dados e visão computacional, a exemplo, \cite{Trindade2018}
...
Alem disso, trabalhos como \cite{Ferrari2008} possuem uma taxa de captura
