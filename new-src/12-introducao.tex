...
Estudos, aplicação e adaptação de métodos de monitoramento de A.
mellifera em T. angustula

% Talve retirar a ideia de comparar os doir

% Talvez tirar justificativa - olhar se não está repetitivo
...
Listar métodos comumente utilizados para monitoração de abelhas com
ferrão (A. mellifera)

Estudar aplicabilidade dos métodos para utilização em abelhas sem
ferrão (T. angulstula)

Aplicar métodos e comparar resultados obtidos
...
exploradas para utilização nas espécies locais, e servirá de base para
futuras exploraçõoes, facilitando assim a aplicação de projetos
semelhantes.
...
das Abelhas sem Ferrão (Amigos das ASF), e auxílio no estudo de prototipagem para a
empresa Geoponica Tecnologia.
...
serão implementados, bem como os requisitos para tal;

	- Desenvolvimento, revelando a realização de cada um dos passos,
bem como problemas e soluções do projeto;
