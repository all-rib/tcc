...
preservação do meio ambiente \cite{Brown2001}. Em 2022, a Associação Brasileira de
Estudo das Abelhas (A.B.E.L.H.A) publicou o Atlas da Apicultura no
Brasil \cite{AbelhaAtlas}. Esta ferramenta reúne dados de instituições como a
...
de 12\% entre 2021 e 2022 \cite{FaoStat}. Um crescimento significativo, mesmo
durante a pandemia. 
...
modelos de comportamento e microgerenciamento \cite{Machado2024}, uma ideia já
aplicada na agricultura de precisão. Porém é um tema novo no Brasil,
quando comparado a outros países pelo mundo\cite{Machado2024}.

Em pesquisas no corpo nacional de publicações\cite{Machado2024}, os maiores esforços
...
apicultura de precisão (AP)\cite{Machado2024}. Contudo, As pesquisas nacionais não
...
\subsection{Objetivos espec\'ificos}\label{subsec:especificos}
