...
Dentre a enorme gama de aplicações, três análises se destacam:
sensoriamento de temperatura, peso e som.

A temperatura, como fator decisivo para o ritmo de trabalho de todas
as espécies, possui adoção quase que unanime.[?] A facilidade de
...
indivíduos dentro da colmeia. Essa variável habilita uma análise da
evolução, até certo ponto[?], do conjunto demanda/oferta. Mas
infelizmente também carece de análise qualitativa dos métodos de
aplicação.
