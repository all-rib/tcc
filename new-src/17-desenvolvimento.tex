...
projetada para lidar com restrições de memória, e possíveis
concorrências de escrita. Essa ferramenta emprega filas do tipo
...
Por fim, a ultima sugestão deu origem à um hardware completamente
novo, denominado Aristeu, que embarca todos os sensores num
encapsulamento nativamente isolado do contato externo, e resistente ao
contato com material orgânico. O mesmo, porém, não chegou à ser
produzido.
