...
Este capítulo trata de explicar os conceitos base relacionados ao
trabalho, em especial sobre abelhas, apicultura, os sensores
utilizados e os respectivos métodos de comunicação.

\section{Abelhas, apicultura e apicultura de precis\~ao}\label{abelhas}
...
desde o Egito Antigo \cite{Danforth2006}, e de crescente importância no
Brasil.
...
(Abelha das Orquídeas)\cite{AbelhaMapa}, sendo aquela a mais numerosa, dado o
...
Apicultura, em Florianópolis \cite{Sanford2005}.
...
\subsection{Tetragonisca angustula}\label{subsec:angustula}

A Tetragonisca angustula, apresentada em \autoref{fig:jatai}, popularmente conhecida como jataí, é uma
...
adaptabilidade e importância ecológica como polinizadora
generalista\cite{Batista2003}.
...
\begin{photograph}[!htb]%% Ambiente figure
    ...
    \caption{\textit{Tetragonisca angustula.}}%% Legenda
    \label{fig:angustula}%% Rótulo
    \includegraphics[scale=0.6]{jatai}%% Dimensões e localização
    \fonte{\citet{Demeter2009}}%% Fonte
...
várias castas, incluindo rainha, operárias e zangões. As colônias são
perenes, podendo conter de 20 a 80 mil indivíduos, abrigadas
geralmente em cavidades protegidas.

\subsection{Colmeias jata\'i}\label{subsec:colmeia}
...
As caixas modelo INPA \cite{INPA} foram desenvolvidas no Brasil para a criação de
...
adaptada às espécies nativas. Apesar de não existir um documento
oficial detalhando o modelo, o mercado melipona segue este padrão.
...
possui a medida padrão, de cada módulo, de 15cm de largura, por 15cm
de profundidade internamente, mais 3cm de espessura, com 10cm de altura.

Módulo de ninho: Parte inferior, onde são depositados os ovos e
construídos os discos de cria. Costuma medir cerca de 15x15x10,
considerando-se as paredes internas, com cerca de 3cm de espessura. O
espaço interno é fixo, sem divisórias móveis, permitindo que as
abelhas organizem o ninho de forma natural.

Sobreninho (ou extensão do ninho): Módulo adicional posicionado acima
do ninho, para fomentar o crescimento. Permite o crescimento da área
de postura e armazenamento, acomodando a expansão natural da colônia
com o tempo.

Melgueira: Espaço dedicado ao armazenamento de mel. Quando presente,
são os módulos superiores. Nela as abelhas constroem pequenos potes de
cera onde depositam o mel. A extração é feita manualmente, com
seringas ou espátulas, respeitando a integridade da colônia.
...
\begin{photograph}[!htb]%% Ambiente figure
    %\captionsetup{width=0.55\textwidth}%% Largura da legenda
    \caption{\textit{Colméia de abelhas Jataí.}}%% Legenda
    \label{fig:colmeia}%% Rótulo
    \includegraphics[scale=0.1]{colmeia}%% Dimensões e localização
...
O sensor BME280, desenvolvido pela Bosch \cite{bme280}, é um dispositivo
...
\begin{photograph}[!htb]%% Ambiente figure
    %\captionsetup{width=0.55\textwidth}%% Largura da legenda
    \caption{Sensor BME280.}%% Legenda
    \label{fig:bme280}%% Rótulo
    \includegraphics[scale=0.2]{bme280}%% Dimensões e localização
    \fonte{Autoria Própria}%% Fonte
    %\addcontentsline{loge}{}{\protect\numberline{\thephotograph}Arquitetura da biblioteca \textbf{HERMES}.} % Adiciona à lista de ilustrações
\end{photograph}
...
integrado \cite{dht11}. Seu princípio de funcionamento baseia-se na variação da
...
\begin{photograph}[!htb]%% Ambiente figure
    %\captionsetup{width=0.55\textwidth}%% Largura da legenda
    \caption{Sensor DHT11.}%% Legenda
    \label{fig:dht11}%% Rótulo
    \includegraphics[scale=0.3]{dht11}%% Dimensões e localização
    \fonte{Autoria Própria}%% Fonte
    %\addcontentsline{loge}{}{\protect\numberline{\thephotograph}Arquitetura da biblioteca \textbf{HERMES}.} % Adiciona à lista de ilustrações
\end{photograph}
...
interface e ampla faixa operacional \cite{ds18b20}. Baseado em tecnologia de
...
\begin{photograph}[!htb]%% Ambiente figure
    %\captionsetup{width=0.55\textwidth}%% Largura da legenda
    \caption{Sensor DS18B20.}%% Legenda
    \label{fig:ds18b20}%% Rótulo
    \includegraphics[scale=0.3]{ds18b20}%% Dimensões e localização
    \fonte{Autoria Própria}%% Fonte
    %\addcontentsline{loge}{}{\protect\numberline{\thephotograph}Arquitetura da biblioteca \textbf{HERMES}.} % Adiciona à lista de ilustrações
\end{photograph}
...
\begin{photograph}[!htb]%% Ambiente figure
    %\captionsetup{width=0.55\textwidth}%% Largura da legenda
    \caption{Sensor SHT30.}%% Legenda
    \label{fig:sht30}%% Rótulo
    \includegraphics[scale=0.2]{sht30}%% Dimensões e localização
    \fonte{Autoria Própria}%% Fonte
    %\addcontentsline{loge}{}{\protect\numberline{\thephotograph}Arquitetura da biblioteca \textbf{HERMES}.} % Adiciona à lista de ilustrações
\end{photograph}
...
\begin{photograph}[!htb]%% Ambiente figure
    %\captionsetup{width=0.55\textwidth}%% Largura da legenda
    \caption{Microfone INMP441.}%% Legenda
    \label{fig:inmp441}%% Rótulo
    \includegraphics[scale=0.2]{inmp441}%% Dimensões e localização
    \fonte{Autoria Própria}%% Fonte
    %\addcontentsline{loge}{}{\protect\numberline{\thephotograph}Arquitetura da biblioteca \textbf{HERMES}.} % Adiciona à lista de ilustrações
\end{photograph}
