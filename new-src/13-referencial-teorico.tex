...
de profundidade, por 10cm de altura.
...
umidade absoluta, ±1 Pa para pressão absoluta e ±0,5 °C para temperatura.
  ...
  1 \begin{figure}[!htb]%% Ambiente figure
  0     %\captionsetup{width=0.55\textwidth}%% Largura da legenda
  1     \caption{Arquitetura da biblioteca \textbf{HERMES}.}%% Legenda
  2     \label{fig:hermes}%% Rótulo
  3     \includegraphics[scale=0.6]{hermes}%% Dimensões e localização
  4     \fonte{Autoria Própria}%% Fonte
  5     %\addcontentsline{loge}{}{\protect\numberline{\thephotograph}Arquitetura da biblioteca \textbf{HERMES}.} % Adiciona à lista de ilustrações
  6 \end{figure}
[Imagem BME280]
